...
class _DropTargetState extends State<DropTarget> {
  ...
  void _onDropEvent(DropEvent event) {
    ...
    final Offset globalPosition = _scaleHoverPoint(context, event.location);
    final Offset position = renderBox.globalToLocal(globalPosition);
    final bool inBounds = renderBox.paintBounds.contains(position);
  ...
  void _updateStatus(
    ...
    _status = status;
    final DropEventDetails details = DropEventDetails(
